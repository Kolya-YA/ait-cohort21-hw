...
//    Print sorted by balance accounts (decrease)
        System.out.println("List of all sorted by balance accounts (" + accounts.length + ')' + " (decrease)");
        Misc.printAccounts(Utils.copySortedByBalance(accounts));

//    Print sorted by client age accounts (increase)
        System.out.println("List of all sorted by client age accounts (" + accounts.length + ')' + "  (increase)");
